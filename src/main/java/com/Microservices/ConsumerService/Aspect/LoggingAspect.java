...
public class LoggingAspect {
    ...
    @Before("execution(* com.Microservices.StockService.Service.*.*(..))")
    ...
    @AfterReturning(pointcut = "execution(* com.Microservices.StockService.Service.*.*(..))", returning = "result")
    ...
    @AfterThrowing(pointcut = "execution(* com.Microservices.StockService.Service.*.*(..))", throwing = "exception")
